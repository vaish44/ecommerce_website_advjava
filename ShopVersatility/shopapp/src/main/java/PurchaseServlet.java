...
public class PurchaseServlet extends HttpServlet {
    ...
    private List<CartItem> getCartItems(String userId) throws SQLException {
        ...
        try (Connection connection = DBConnection.getConnection()) {
            ...
            String query = "SELECT products.id as product_id, products.name as product_name, price, COUNT(*) as quantity FROM cart,products WHERE paid = true and userid = ? and cart.productid=products.id GROUP BY products.id";
